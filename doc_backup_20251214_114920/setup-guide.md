...
```bash
# Esegui script SQL dal doc/database-design.md
...
1. ✅ Setup completato
2. Leggi [User Guide](user-guide.md) per utilizzo
3. Consulta [API Documentation](api-documentation.md) per sviluppo
4. Vedi [Architecture](architecture.md) per comprendere struttura
